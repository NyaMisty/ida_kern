...
struct std__basic_istringstream_wchar_t_;
struct std__basic_ostringstream_wchar_t_;
typedef int custom_viewer_get_place_xcoord_t(TWidget *, const place_t *, const place_t *, void *);
typedef void custom_viewer_location_changed_t(TWidget *, const lochist_entry_t *, const lochist_entry_t *, const locchange_md_t *, void *);
struct ida_movable_type_bpt_location_t_ {};
struct ida_movable_type_locchange_md_t_ {};
struct ida_movable_type_process_info_t_ {};
struct ida_movable_type_refinfo_desc_t_ {};
...
struct _Real_widened_double__float_ {};
struct _Real_widened_float__double_ {};
typedef void custom_viewer_adjust_place_t(TWidget *, lochist_entry_t *, void *);
typedef int custom_viewer_can_navigate_t(TWidget *, const lochist_entry_t *, const locchange_md_t *, void *);
...
struct ida_movable_type_snapshot_t_ {};
struct ida_movable_type_twinline_t_ {};
typedef const regval_t *processor_t__regval_getter_t(const char *, const regval_t *);
...
typedef void custom_viewer_mouse_moved_t(TWidget *, int, view_mouse_event_t *, void *);
...
struct std__piecewise_construct_t {};
typedef void code_viewer_lines_click_t(TWidget *, const place_t *, int, int, void *);
...
typedef int code_viewer_lines_icon_t(TWidget *, const place_t *, int *, void *);
typedef bool custom_viewer_dblclick_t(TWidget *, int, void *);
...
typedef bool custom_viewer_keydown_t(TWidget *, int, int, void *);
struct ida_movable_type_bpt_t_ {};
struct ida_movable_type_kvp_t_ {};
struct ida_movable_type_seh_t_ {};
...
typedef void custom_viewer_curpos_t(TWidget *, void *);
...
typedef bool custom_viewer_click_t(TWidget *, int, void *);
typedef void custom_viewer_close_t(TWidget *, void *);
typedef void custom_viewer_popup_t(TWidget *, void *);
...
typedef int custom_viewer_help_t(TWidget *, void *);
...
typedef void config_changed_cb_t(const cfgopt_t *, int, const void *);
...
typedef int lx_preprocessor_cb(void *, const char *, int, const char *);
...
typedef const char *cfgopt_handler_t(lexer_t *, const token_t *, const token_t *);
...
typedef bool is_stkarg_load_t(const insn_t *, int *, int *);
...
typedef void ss_restore_cb_t(const char *, void *);
struct std__less_void_ {};
struct std__plus_void_ {};
...
typedef bool set_op_tinfo_t(const insn_t *, const op_t *, const tinfo_t *, const char *);
struct std___Num_base {};
struct std__less_int_ {};
struct std__nothrow_t {};
...
typedef int lx_warning_cb(void *, const char *);
...
typedef const char *set_options_t(const char *, int, const void *, bool);
struct source_view_t;
struct std__ios_base;
...
typedef int lx_pragma_cb(void *, const char *);
struct merge_data_t;
...
typedef int formchgcb_t(int, form_actions_t *);
...
typedef int lx_macro_cb(void *, const char *, const char *, int, bool, bool);
typedef int lx_undef_cb(void *, const char *);
...
typedef int buttoncb_t(int, form_actions_t *);
...
typedef int importer_t(linput_t *, impinfo_t *);
...
typedef int local_tinfo_predicate_t(uint32, const tinfo_t *, void *);
...
typedef error_t idc_func_t(idc_value_t *, idc_value_t *);
...
typedef ssize_t external_colorizer_t(syntax_highlight_style *, const char *);
typedef lecvt_code_t lochist_entry_cvt2_t(lochist_entry_t *, const lochist_entry_t *, TWidget *, uint32);
...
typedef int32 demangler_t(char *, uint, const char *, uint32);
...
typedef const char *cfgopt_handler2_t(lexer_t *, const token_t *, const token_t *, int64, int64);
typedef const char *cfgopt_handler3_t(lexer_t *, const token_t *, const token_t *, int64, int64, void *);
typedef bool has_delay_slot_t(ea_t);
typedef int html_footer_cb_t(FILE *);
typedef int html_header_cb_t(FILE *);
typedef bool may_destroy_cb_t(ea_t);
...
typedef int h2ti_type_cb(const char *, const tinfo_t *, const char *, const uint64 *, void *);
...
typedef bool external_ident_colorizer_t(syntax_highlight_style *, const qstring *);
...
typedef uint32 nav_colorizer_t(ea_t, asize_t, void *);
struct textctrl_info_t {size_t cb;qstring text;uint16 flags;uint16 tabsize;};
typedef int html_line_cb_t(FILE *, const qstring *, bgcolor_t, bgcolor_t);
...
union cfgopt_t___99DF67CCA67C584E9D46033DDA6FC151 {void *ptr;size_t mbroff;cfgopt_handler_t *hnd;cfgopt_handler2_t *hnd2;cfgopt_handler3_t *hnd3;};
...
struct abstract_graph_t : gdl_graph_t {qstring title;bool rect_edges_made;layout_type_t current_layout;point_t circle_center;int circle_radius;hook_cb_t *callback;void *callback_ud;};
...
struct cfgopt_t {const char *name;union {void *ptr;size_t mbroff;cfgopt_handler_t *hnd;cfgopt_handler2_t *hnd2;cfgopt_handler3_t *hnd3;};int flags;union {size_t buf_size;cfgopt_t__num_range_t num_range;uint32 bit_flags;cfgopt_t__params_t params;void *mbroff_obj;};};
...
typedef void syntax_highlighter_t__block_highlighter_t(void *, highlighter_cbs_t *, const qstring *);
...
typedef bool code_viewer_lines_linenum_t(TWidget *, const place_t *, uval_t *, void *);
...
struct syntax_highlighter_t {syntax_highlighter_t_vtbl *__vftable /*VFT*/;syntax_highlighter_t__block_highlighter_t *highlight_block;};
