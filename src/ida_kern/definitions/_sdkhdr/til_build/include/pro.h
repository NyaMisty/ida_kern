...
public:
  ...
  /// Split a string on 'sep', filling 'out' with the parts
  /// \param out storage
  ...
  /// Join the provided parts, using the contents of this
  /// string as a separator
  /// \param parts the parts to join
  /// \param sep the separator to join on
